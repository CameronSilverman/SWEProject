			...
			<div className="relative z-10 max-w-4xl mx-auto px-4 pt-32 pb-12">
				...
				<div className="space-y-6 text-gray-100 backdrop-blur-sm bg-white/10 p-8 rounded-xl">
					...
					<section>
						...
						<p className="mb-4">
							All projects hosted on our platform must comply with open source
							licensing requirements. Users are responsible for ensuring they
							have the necessary rights to contribute to projects.
						</p>
					</section>
					...
					<section>
						...
						<p className="mb-4">
							...
							disrupts the platform services or servers and networks connected
							to the platform.
						</p>
					</section>
					...
					<section>
						...
						<p className="mb-4">
							Users retain all rights to their contributions while granting
							necessary licenses for their contributions to be used within the
